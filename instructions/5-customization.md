...
At this point, you should have a working copy of the FIFA Galaxy skill.  In order to make it your own, you will need to customize it with data and responses that you create.  Here are the things you will need to change:
...
1. **New data.** You can add more facts about the players already listed or add data about new players, teams or leagues.
    ...
    3. **When you have replaced the data in facts.js, copy the contents of your file to your Lambda function.**  This should be as simple as copying the text, and pasting it into the code box for your Lambda.

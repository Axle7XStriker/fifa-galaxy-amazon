...
2. **Clone** the repository.
  ...
  ```bash
  $ git clone https://github.com/Axle7XStriker/fifa-galaxy-amazon.git
  ```
...
2. Simulate verbal interaction with your skill through the command line (this might take a few moments) using the following example, using the locale of your choice (en-US):

	```bash
	 $ ask simulate -l en-GB -t "start fifa galaxy"

	 ✓ Simulation created for simulation id: 00000000-0000-0000-0000-000000000000
...
1. ```./skill.json```
   ...
   Remember than many information are locale-specific and must be changed for each locale (en-IN, en-US, etc.)
...
2. ```./lambda/index.js```, ```./lambda/facts.js```
